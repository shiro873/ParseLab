...
const jsonStore_1 = require("../src/store/jsonStore");
...
describe('JSON Store Integration', () => {
    ...
    beforeEach(() => {
        ...
        store = new jsonStore_1.JsonStore(testStoreDir);
    ...
    describe('Cache fallback integration', () => {
        ...
        it('should handle cache expiry scenario', async () => {
            ...
            const storedResult = await jsonStore_1.jsonStore.getJobResult(job.jobId);
